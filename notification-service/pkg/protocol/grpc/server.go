...
import (
	...
	"github.com/hoangbktech/cinema-bookings/notification-service/pkg/protocol/grpc/middleware"
	"google.golang.org/grpc"
)

func RunServer(ctx context.Context, v1API v1.NotificationServiceServer, port string) error {
